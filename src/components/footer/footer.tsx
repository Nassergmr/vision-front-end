...
export default function Footer() {
  ...
  // Await content until page loads
  useEffect(() => {
        ...
        <div className="mx-auto w-full max-w-7xl">
                ...
                <ul key={title}>
                  ...
                  {items.map((link) => (
                    <li key={link}>
                      <div
                        color="gray"
                        className="py-1.5 cursor-pointer w-fit font-normal transition-colors hover:text-blue-gray-900"
                      >
                        {link}
                      </div>
                    </li>
          ...
          <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
            <div className="mb-4 text-center font-normal text-blue-gray-900 md:mb-0">
              &copy; {currentYear} <span>Vision</span>. All Rights Reserved.
            </div>
