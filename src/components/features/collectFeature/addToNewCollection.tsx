    ...
    <>
      ...
      <div className="flex items-center gap-2 mt-5 justify-center">
        <button
          ...
          className="cursor-pointer flex items-center gap-2 border-1 border-[#EDEDED] hover:border-gray-500 hover:bg-gray-100 transition-all duration-300 py-2.5 lg:px-5 px-3.5 md:text-lg rounded-lg"
        >
          Back
        </button>
        ...
        <button
          ...
          className={`text-center gap-2 border-1 transition-all duration-300  py-2.5 lg:px-5 px-3.5 md:text-lg rounded-lg  text-white ${
            loading
